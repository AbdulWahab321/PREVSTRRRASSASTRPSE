...
async function draw(){
 if(navigator.onLine){
   ...
   alert("You need Internet Connection to work this game")
   window.close();
 }
...
if (window.navigator.userAgent.indexOf("Windows NT 5.0") != -1){
  ...
  if (window.navigator.userAgent.indexOf("Win64") != -1||navigator.userAgent.indexOf("WOW64") != -1 ){
    bit="64 bit"
   }

   if (window.navigator.userAgent.indexOf("Win32") != -1||navigator.userAgent.indexOf("WOW32") != -1 ){
    bit="32 bit"
   }
  ...
  background(first);
 fill("white") 
text("v Street Racer Versions v",250,400)
text("V UPDATED V",300,470)
text("v TOP 1 v",50,520)
  Pe=createButton("ULTIMATE (PKC)")
  Pe.position(100,550)
  Pe.size(100,50)

  SPe=createButton("Normal Edition")
  SPe.position(650,550)
  SPe.size(100,50)

  SpaceShooter=createButton("Space Shooter")
  SpaceShooter.position(350,300)
  SPe.size(100,50)
  Pe.mousePressed(()=>{
    init=true
  ...
  if(init===true){
    ...
    if(frameCount%150===0){
      open("https://abdulwahab321.github.io/Street-Racer-Police-Chase/")
    }
  }
  ...
  if(init1===true){
    text("Initializing....",100,270)
    if(frameCount%150===0){
      open("https://abdulwahab321.github.io/Street-Racer-10.5/")
    }
  }
if(gameState===CDI){
...
if(gameState===checkedSystem){
  ...
  if (navigator.userAgent.indexOf("Android") != -1) {
    ...
    if(frameCount-250===0){
      open("https://abdulwahab321.github.io/Street-Racer-Async-Preload-Function-Mobile-Edition/")
    }
  }
  if (navigator.userAgent.indexOf("like Mac") != -1) {
    NameW =
